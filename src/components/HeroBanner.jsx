...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full relative bg-[#111111] overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                >
                    <h1 className="text-[40px] md:text-[100px] 2xl:text-[160px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
                        Hii.. It's    Sudhir
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Sudhir kumar</span>
                    </div>
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="w-[300px] md:w-[360px] 2xl:w-[750px] absolute bottom-0 left-[1005px] -translate-x-1/2"
                    initial={{ y: 300, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
                    <img src={man} className="min-w-[125%] mb-[-27px]" alt="" />

                    {/* HIRE ME BUTTON START */}
                    <div
                        className="mr-[163%] absolute top-[140px] 2xl:-right-10 w-[140px] h-[140px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => scrollTo("contact")}
                    >
                        <img
                            ...
                            className="w-[15px]"
                        />
                        <div className="text-black">Ask Query</div>
                    </div>
                    {/* HIRE ME BUTTON END */}
                </motion.div>
                {/* PERSON BLOCK END */}
