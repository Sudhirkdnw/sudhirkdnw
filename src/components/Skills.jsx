                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="Ui/Ux Design"
                            desc="In the realm of digital technology, User Interface (UI) and User Experience (UX) design play pivotal roles in shaping the way users interact with and perceive digital products, services, and platforms. These two intertwined disciplines, while distinct, are inseparable in the pursuit of creating seamless and impactful user experiences."
                            data={[
                                "HTLM",
                                "CSS",
                                "JAVASCRIPT",
                        ...
                        <Service
                            ...
                            desc="Your proficiency in programming languages like C, C++, Java, Python, and JavaScript reflects a well-rounded skill set that covers a wide spectrum of software development. Let's explore how your mastery of these languages equips you with the ability to tackle various aspects of programming and software engineering:"
                            data={[
                                "C",
                                "C++",
                                "JAVA",
                        ...
                        <Service
                            num="3"
                            title="Data Base "
                            desc="Absolutely, your database skills are a valuable addition to your technical repertoire. Proficiency in databases like MongoDB, MySQL, and tools like phpMyAdmin further enhances your capabilities in the realm of software development and data management. Let's explore how these skills can contribute to your digital endeavors:"
                            data={[
                                "MY SQL",
                                "MANGO DB",
                                "ORACAL",
                        ...
                        <Service
                            ...
                            desc="Certainly, your proficiency in these technologies is quite impressive and can undoubtedly contribute to the creation of innovative digital solutions. Let's break down how your skills in Django, React JS, Node JS, and WordPress empower you to bring your ideas to life in the digital realm:"
                            data={[
                                "DJANGO",
                                "FLASK",
                                "Vue JS",
